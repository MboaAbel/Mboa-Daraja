# Generated by Django 3.0.5 on 2023-11-07 19:43
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(choices=[('Nai', 'Nairobi'), ('Ngo', 'Ngong'), ('Ron', 'Rongai'), ('Kaw', 'Kawangware')], max_length=100)),
        ...
        migrations.AddField(
            model_name='product',
            name='category',
            field=models.CharField(choices=[('PR', 'Premium'), ('LX', 'Luxury'), ('OW', 'Comfort'), ('EC', 'Economy'), ('BS', 'Basic')], default='BS', max_length=2),
        ),
        migrations.AddField(
            model_name='product',
            name='slug',
            field=models.SlugField(default='MBOA'),
        ),
    ]
